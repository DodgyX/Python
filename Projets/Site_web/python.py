...
def backup(var):
    ...
    try:
        ...
        with open(r'C:\Users\yoann.wiss\Desktop\python\Projets\Site_web\output.json', 'w', encoding='utf-8') as file:
            json.dump(json_data, file, indent=2)
    except Exception as e:
        print(f'Failed to download JSON. Error: {e}')

# r'C:\Users\yoann.wiss\Desktop\python\Projets\Site_web\output.json'

    with open(r'C:\Users\yoann.wiss\Desktop\python\Projets\Site_web\output.json') as mon_fichier:
